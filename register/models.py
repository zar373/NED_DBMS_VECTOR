...
# models to interact with data types and orm
# forms to interact with HTML
# urls detect paths between models and views
# views detect path between http and html file
